...
.. exec-shell::
   ...
   randomname generate verb/ adj/ pokemon/names in pokemon/cities -n 15

The wordlists and their sources can be found `here`_.
...
.. exec-shell::
   ...
   randomname get colors,geometry cats -n 10
   ...
   # using the `-n` parameter runs `randomname generate` n times and ensures uniqueness

   # e.g. verbs/music adjectives/colors nouns/cats
   randomname generate v/music a/colors n/cats

   randomname generate v/music a/colors n/cats -n 10
